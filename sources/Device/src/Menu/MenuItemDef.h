...
#define DEF_PAGE_4(name, keeper, title, item0, item1, item2, item3, func_draw_closed)               \
...
#define DEF_PAGE_5(name, keeper, title, item0, item1, item2, item3, item4, func_draw_closed)        \
