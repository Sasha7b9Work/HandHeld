...
/*
    * заливка экрана цветом, выбранным в настройках при вызове
    * будильник надо проверить
    * реализовать механизм выключения : если PWR_CTRL(PA0) перешёл в 0, то это одно
    ...
    * Таймаут свечения экрана 20с.Хорошо бы, кнопка 'left' имела функцию принудительного
