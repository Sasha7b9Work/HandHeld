...
#ifdef TYPE_1602
    static Button btnMenu(GPIOB, GPIO_PIN_6, EXTI2_3_IRQn, EXTI_SOURCE_GPIOB, EXTI_SOURCE_PIN2, EXTI_2); 
    static Button btnCancel(GPIOB, GPIO_PIN_4, EXTI0_1_IRQn, EXTI_SOURCE_GPIOB, EXTI_SOURCE_PIN0, EXTI_0);
    static Button btnUp(GPIOB, GPIO_PIN_5, EXTI4_15_IRQn, EXTI_SOURCE_GPIOA, EXTI_SOURCE_PIN7, EXTI_7);
    static Button btnDown(GPIOB, GPIO_PIN_15, EXTI0_1_IRQn, EXTI_SOURCE_GPIOB, EXTI_SOURCE_PIN1, EXTI_1);
#else
