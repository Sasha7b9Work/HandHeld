...
namespace CMT2210AW
{
    ...
    static uint32_t valid_packet_flag = 0;
...
const uint8_t BITSSETTABLEFF[2048] = {0, 1, 1, 2, 1, 2, 2, 3, 1, 2, 2, 3, 2, 3, 3, 4, 1, 2, 2, 3, 2, 3, 3, 4, 2, 3, 3, 4, 3, 4, 4, 5,
...
*/
    ...
    if(valid_packet_flag && (packet == 0x8D))
    {
